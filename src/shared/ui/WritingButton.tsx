...
export const WritingButton = ({ disabled = false }: WritingButtonProps) => {
  return (
    <button
      disabled={disabled}
      className="group w-full py-3.25 flex items-center justify-center gap-2 rounded-xl bg-primary-600 hover:bg-primary-1000 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
    >
