    ...
    <section className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="rounded-2xl border border-border-deactivated bg-white px-4 py-3">
          <label className="text-label-06 text-text-placeholder" htmlFor="admin-post-id-filter">
            게시글 ID 필터
          </label>
          <input
                  ...
                  : comments.map((comment) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-4">
                          <AdminStatusBadge tone={comment.hiddenByAdmin ? "red" : "green"}>
                        ...
                        <td className="px-5 py-4">
                          <div className="flex flex-wrap gap-2">
                            <Button
                              disabled={patchCommentVisibilityMutation.isPending}
                              onClick={() =>
