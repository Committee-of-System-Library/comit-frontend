    ...
    <section className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-body-02 text-text-secondary">
            접수된 신고를 확인하고 상세 모달에서 바로 검토 상태를 바꿀 수 있습니다.
          </p>
        </div>
                ...
                {reportsQuery.isLoading
                  ...
                  : reports.map((report) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-4">
                          <AdminStatusBadge tone={reportStatusTones[report.status]}>
      ...
      {selectedReportId !== null ? (
        <AdminReportDetailModal
          ...
          errorMessage={
            reportDetailQuery.isError && reportDetailQuery.error instanceof Error
